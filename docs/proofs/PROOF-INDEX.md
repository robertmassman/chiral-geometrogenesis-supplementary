...
| 0.0.3b | Geometric Realization Completeness | [Theorem-0.0.3b-Geometric-Realization-Completeness.md](foundations/Theorem-0.0.3b-Geometric-Realization-Completeness.md) |
...
| 0.0.9 | Framework Internal D4 Derivation | [Theorem-0.0.9-Framework-Internal-D4-Derivation.md](foundations/Theorem-0.0.9-Framework-Internal-D4-Derivation.md) |
...
| 0.0.15 | Topological Derivation SU(3) | [Theorem-0.0.15-Topological-Derivation-SU3.md](foundations/Theorem-0.0.15-Topological-Derivation-SU3.md) |
...
### Propositions (0.0.6x - Continuum Limit)
...
### Propositions (0.0.16a - Adjacency)
...
### Propositions (0.0.17 series - Information Geometry & Quantum)
...
### Propositions (0.0.17 series - QCD Scale Derivations)
...
### Propositions (0.0.17 series - Cosmology & Scale Hierarchy)
...
### Propositions (0.0.17 series - Bootstrap)
...
### Propositions (0.0.17aa series - Spectral Analysis)

| Number | Title | File |
|--------|-------|------|
| 0.0.17aa | Spectral Index From First Principles | [Proposition-0.0.17aa-Spectral-Index-From-First-Principles.md](foundations/Proposition-0.0.17aa-Spectral-Index-From-First-Principles.md) |

### Propositions (0.0.17ab - Newton's Constant)
...
**16 files** — Pre-geometric foundations (0.1.x - 0.3.x numbering)
...
| Number | Title | Files |
|--------|-------|-------|
| 0.1.0 | Field Existence From Distinguishability | [Theorem-0.1.0-Field-Existence-From-Distinguishability.md](Phase0/Theorem-0.1.0-Field-Existence-From-Distinguishability.md) |
| 0.1.0 | Prime Fields From Gauge Bundle Structure | [Theorem-0.1.0-Prime-Fields-From-Gauge-Bundle-Structure.md](Phase0/Theorem-0.1.0-Prime-Fields-From-Gauge-Bundle-Structure.md) |
...
**6 files** — SU(3) geometry and chiral field definitions
...
**31 files** — Pressure-depression mechanism and phase dynamics
...
**15 files** — Topological solitons and matter
...
**41 files** — Emergent spacetime and gravity
...
| 5.2.4 | Newton's Constant Chiral Parameters | [Statement](Phase5/Theorem-5.2.4-Newtons-Constant-Chiral-Parameters.md), [Derivation](Phase5/Theorem-5.2.4-Newtons-Constant-Chiral-Parameters-Derivation.md), [Applications](Phase5/Theorem-5.2.4-Newtons-Constant-Chiral-Parameters-Applications.md) |
...
**16 files** — Renormalization, unitarity, and consistency
...
**17 files** — Predictions and experimental tests
...
| Number | Title | Files |
|--------|-------|-------|
| 8.2.1 | Experimental Proposal | [Prediction-8.2.1-Experimental-Proposal.md](Phase8/Prediction-8.2.1-Experimental-Proposal.md) |
| 8.2.1 | QGP Phase Coherence | [Statement](Phase8/Prediction-8.2.1-QGP-Phase-Coherence.md), [Derivation](Phase8/Prediction-8.2.1-QGP-Phase-Coherence-Derivation.md), [Applications](Phase8/Prediction-8.2.1-QGP-Phase-Coherence-Applications.md) |
...
**6 files** — Constants, techniques, and protocols
...
**352 files** — Multi-agent verification reports
