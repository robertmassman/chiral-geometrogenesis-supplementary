...
def create_figure_time_emergence_from_docs(output_dir=None):
    """
    ...
    ax.text(0.08, -0.15, 'O', fontsize=10, color='black', fontweight='bold')
    ...
    ax.text(-1.45, 1.2, coord_text, fontsize=8, fontfamily='monospace',
    ...
    # Save figures
    for ext in ['pdf', 'png']:
        filepath = os.path.join(output_dir, f'figure_time_emergence_from_docs.{ext}')
...
if __name__ == "__main__":
    ...
    output_dir = os.path.dirname(os.path.abspath(__file__))
    metadata = create_figure_time_emergence_from_docs(output_dir)
